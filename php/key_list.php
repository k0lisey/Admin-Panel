<?php
    ...
    $keys_non_active_count = R::count('kluchi', 'activated = ?', [0]);
    $keys_non_active = R::findAll('kluchi', 'activated = ?', [0]);
?>
...
<div id="alert" class="animated bounceInDown"></div>
    ...
    <div class="content_add">
        <div class="left_panel">
            ...
            <div class="info_db">
                ...
                <p>Неактивированно ключей: <?=$keys_non_active_count?></p>
                <p>Заблокированно пользователей: <?=$users_banned_count?></p>
            </div>
            <hr>
            <div class="action_key">
                <a class="active" href="key_list.php">
        ...
        <div class="main_panel">
            ...
            <div class="user-list">
                <table class="custom">
                    ...
                    <tbody class="add">
                        <?php
                            foreach($keys_non_active as $keys_):
                        ?>
                        <tr>
                            <td scope="row"><?=$keys_['kluch']?></td>
                            <td scope="row">
                                <?php echo '<button type="button" class="btn btn-copy" id="suda" data-id="'.$keys_['kluch'].'"><i class="far fa-copy"></i></button>'; ?>
                            </td>
                        </tr>
                        <?php
                            endforeach;
    ...
    <script>
        ...
        $('.btn-copy').click(function(){
            ...
            show_alert_suc('<div><i class="far fa-check-circle"></i></div><div><p>Ключ Скопирован</p></div>');
        });
