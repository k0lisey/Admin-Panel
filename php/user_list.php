        ...
        <div class="main_panel">
            ...
            <div class="user-list">
                <table class="custom">
                    ...
                    <tbody class="add">
                        <?php
                            foreach ($users_not_banned as $user):
                        ?>
                        <tr id="<?=$user['id']?>">
                            <td id="id" scope="row"><?=$user['id']?></td>
                            <td id="username"><?=$user['username']?></td>
                            <td id="hwid"><?=$user['hwid']?></td>
                            <td id="date_end_sub"><?=$user['date_end_sub']?></td>
                            <td id="sub">
                                <?php
                                    if ($user['sub'] == 0)
                                        echo 'Нет';
                            ...
                            <td>
                                <!-- <button type="button" class="btn btn-edit" id="btn_edit">Редактировать</button> -->
                                <?php echo '<button type="button" class="btn btn-ban" id="ban" data-id="'.$user['id'].'">Заблокировать</button>'; ?>
    ...
    <script>
        ...
        $('#ban').click(function() {
            ...
            $.ajax({
                ...
                .done(function(msg) {
                    if (msg == true) {
                        show_alert_suc('<div><i class="far fa-check-circle"></i></div><div><p>Пользователь успешно забанен</p></div>');
